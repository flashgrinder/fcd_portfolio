...
(function (l, o) {
  typeof exports == "object" && typeof module < "u" ? module.exports = o() : typeof define == "function" && define.amd ? define(o) : (l = typeof globalThis < "u" ? globalThis : l || self, l.HystModal = o());
})(void 0, function () {
  "use strict";

  var D = Object.defineProperty;
  var z = (l, o, d) => o in l ? D(l, o, {
    enumerable: !0,
    configurable: !0,
    writable: !0,
    value: d
  }) : l[o] = d;
  var u = (l, o, d) => (z(l, typeof o != "symbol" ? o + "" : o, d), d); /**
  ...
  var v = 0,
    ...
    E = !l() && "scrollBehavior" in document.documentElement.style,
    M = function () {
      var e = document.body,
    ...
    T = function () {
      ...
      return e.style.height = "100%", e.style.overflow = "hidden", t.style.top = "-".concat(s, "px"), t.style.width = "100%", t.style.height = "auto", t.style.position = "fixed", t.style.overflow = "hidden", function () {
        e.style.height = n.height || "", e.style.overflow = n.overflow || "", ["top", "width", "height", "overflow", "position"].forEach(function (a) {
          t.style[a] = i[a] || "";
        }), E ? window.scrollTo({
          top: s,
          behavior: "instant"
          ...
          if (e) {
            ...
            t.forEach(function (s) {
              s && h.indexOf(s) === -1 && (s.ontouchstart = function (n) {
                ...
                n.targetTouches.length === 1 && B(n, s);
              }, h.push(s));
            });
          }
          f || (document.addEventListener("touchmove", m, L), f = !0);
        } else v <= 0 && (g = o().android ? T() : M());
        v += 1;
      }
    },
    _ = function () {
      if (!l()) {
        if (v = 0, !o().ios && typeof g == "function") {
          g();
          return;
        }
        if (h.length) for (var e = h.pop(); e;) e.ontouchmove = null, e.ontouchstart = null, e = h.pop();
        f && (document.removeEventListener("touchmove", m, L), f = !1);
      }
    };
  const W = "";
  class p {
    ...
    eventsFeeler() {
      ...
      document.addEventListener("click", t => {
        const s = t.target,
          n = s.closest("[".concat(this.config.linkAttributeName, "]"));
        if (n && !this.isBusy) {
          this.isBusy = !0, t.preventDefault();
          const r = this.config.linkAttributeName,
            y = r ? n.getAttribute(r) : null;
          y && this.open(y, n.hasAttribute("data-stacked"), n);
          return;
        }
        const i = s.closest("[data-hystclose]");
        if (this.config.closeOnButton && i && !this.isBusy) {
          this.isBusy = !0, t.preventDefault();
          const r = s.closest(".hystmodal");
          r && this.close(r);
          return;
        }
    ...
    openObj(e) {
      ...
      return _asyncToGenerator(function* () {
        let t = _arguments.length > 1 && _arguments[1] !== undefined ? _arguments[1] : !1;
        if (_this.config.beforeOpen && _this.config.beforeOpen(e, _this), _this.stopTrigger) {
          _this.stopTrigger = !1;
          return;
        }
        if (_this.config.isStacked || t) {
          const i = _this.openedModals.filter(a => a.element === e.element);
          yield Promise.all(i.map( /*#__PURE__*/function () {
            var _ref2 = _asyncToGenerator(function* (a) {
              yield _this.closeObj(a, !1, !0, !1);
            });
            return function (_x) {
              return _ref2.apply(this, arguments);
            };
          }()));
        } else yield _this.closeAll(), _this.openedModals = [];
        if (_this.isBodyLocked || _this.bodyScrollControl(e, "opening"), !e.element.querySelector(".hystmodal__window")) throw new Error("Warning: selector .hystmodal__window not found in modal window");
        _this.openedModals.push(e), e.element.classList.add("hystmodal--animated"), e.element.classList.add("hystmodal--active"), e.element.style.zIndex = e.zIndex.toString(), e.element.setAttribute("aria-hidden", "false");
        const n = getComputedStyle(e.element).getPropertyValue("--hystmodal-speed");
        _this.focusIn(e.element), setTimeout(() => {
          e.element.classList.remove("hystmodal--animated"), _this.isBusy = !1;
        }, p.cssParseSpeed(n));
      })();
    }
    open(e) {
      var _arguments2 = arguments,
        _this2 = this;
      return _asyncToGenerator(function* () {
        let t = _arguments2.length > 1 && _arguments2[1] !== undefined ? _arguments2[1] : _this2.config.isStacked;
        let s = _arguments2.length > 2 && _arguments2[2] !== undefined ? _arguments2[2] : null;
        const n = _this2.getActiveModal(),
          i = e ? document.querySelector(e) : null;
        if (!i) throw new Error("Warning: selector: ".concat(e, " not found on document"));
        const a = getComputedStyle(i).getPropertyValue("--hystmodal-zindex"),
          r = {
            element: i,
            openedWindow: i,
            starter: s,
            zIndex: n ? n.zIndex + _this2.openedModals.length : parseInt(a, 10),
            config: _this2.config,
            isOpened: !1
          };
        return yield _this2.openObj(r, t), _this2.isBusy = !1, r;
      })();
    }
    closeObj(e) {
      ...
      return new Promise(i => {
        ...
        const a = getComputedStyle(e.element).getPropertyValue("--hystmodal-speed");
        e.element.setAttribute("aria-hidden", "false"), this.openedModals = this.openedModals.filter(r => r.element !== e.element), setTimeout(() => {
        ...
        }, this.config.waitTransitions && !s ? p.cssParseSpeed(a) : 0);
      });
    }
    close() {
      var _arguments3 = arguments,
        _this3 = this;
      return _asyncToGenerator(function* () {
        let e = _arguments3.length > 0 && _arguments3[0] !== undefined ? _arguments3[0] : null;
        if (!e) {
          const s = yield _this3.closeAll();
          return s.length ? s[s.length - 1] : null;
        }
        const t = _this3.openedModals.find(s => s.element === e);
        return t ? (yield _this3.closeObj(t, !0), _this3.isBusy = !1, t) : null;
      })();
    }
    closeAll() {
      var _this4 = this;
      return _asyncToGenerator(function* () {
        const e = [];
        return yield Promise.all(_this4.openedModals.map( /*#__PURE__*/function () {
          var _ref3 = _asyncToGenerator(function* (t) {
            yield _this4.closeObj(t, !0), e.push(t);
          });
          return function (_x2) {
            return _ref3.apply(this, arguments);
          };
        }())), _this4.openedModals = [], _this4.isBusy = !1, e;
      })();
    }
    focusIn(e) {
    ...
    bodyScrollControl(e, t) {
      ...
      this.config.backscroll && !this.isBodyLocked && (A(e.element), this.isBodyLocked = !0);
...
},{"hystmodal":2}],95:[function(require,module,exports){
"use strict";
...
function init() {
  _swiper.default.use([_swiper.Navigation, _swiper.Autoplay, _swiper.EffectFade, _swiper.Pagination]);
  const portfolio = new _swiper.default(".js-portfolio-slider", {
    effect: 'fade',
    fadeEffect: {
      crossFade: true
    },
...
var _portfolio = _interopRequireDefault(require("../libs/modules/portfolio"));
...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  portfolioTrue ? _portfolio.default.init() : false;
  _modal.default.init();
});

},{"../libs/modules/portfolio":95,"../libs/modules/tabs":96,"./modules/modal":94}]},{},[97]);
